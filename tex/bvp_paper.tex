...
evolving over the course of thermal timescales which are much larger than
the relevant dynamical advective
...
bottom of the atmosphere. $\xi$ is a general depth-dependent scaling factor which
tells us roughly how much larger F$_\text{E}$ is in the interior than it should
be in the thermally equilibrated state.
...
before solving for the evolved temperature profile.
