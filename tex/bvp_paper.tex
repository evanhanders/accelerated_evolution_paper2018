...
fast-forwarding through the long thermal relaxation of convective simulations, and we test the
validity of this method. This Accelerated Evolution (AE) method involves measuring the dynamics of convection
...
of solutions which are reached through Standard Evolution (SE) over a full thermal diffusion timescale.
At the highest values of the Rayleigh number at which we compare SE and AE,
we find that AE solutions require roughly an order of magnitude fewer computing
to evolve than SE solutions.
\end{abstract}
\maketitle
